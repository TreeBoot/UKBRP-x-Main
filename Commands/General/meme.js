...
const fetch = (...args) => import('node-fetch').then(({default: fetch}) => fetch(...args)); //since require is not supportet we will use this workaround to import node-fetch
    ...
    data: new SlashCommandBuilder()
        ...
        async execute(interaction) {
            ...
            async function giphyMeme() {
                await fetch('https://api.giphy.com/v1/gifs/random?api_key=Zu6ct2bowQ91SzocbGBL01FHP9LpEHn6&tag=&rating=g').then(async res => {
                    let meme = await res.json();
